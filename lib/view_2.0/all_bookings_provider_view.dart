...
class AllBookingsProviderView extends StatefulWidget {
  AllBookingsProviderView({super.key});
  bool isDark = false;
  String categoryToPopulate = '';

  AllBookingsProviderView.WithPersistedTheme(
...
class _AllBookingsProviderViewState extends State<AllBookingsProviderView> {
  ...
  Future<void> asyncInit() async {
    final newStream = await BookingController().getBookingsForServiceProvider();
    setState(() {
      stream = newStream;
    });
  }
